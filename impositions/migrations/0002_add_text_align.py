...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TemplateRegion.justify'
        db.delete_column('impositions_templateregion', 'justify')

        # Adding field 'TemplateRegion.text_align'
        db.add_column('impositions_templateregion', 'text_align',
                      self.gf('django.db.models.fields.CharField')(default='LEFT', max_length=20, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'TemplateRegion.justify'
        db.add_column('impositions_templateregion', 'justify',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'TemplateRegion.text_align'
        db.delete_column('impositions_templateregion', 'text_align')
