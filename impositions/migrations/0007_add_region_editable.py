...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TemplateRegion.editable'
        db.add_column('impositions_templateregion', 'editable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TemplateRegion.editable'
        db.delete_column('impositions_templateregion', 'editable')
    ...
    models = {
        ...
        'impositions.compositionregion': {
            'Meta': {'ordering': "['template_region__top', 'template_region__left']", 'object_name': 'CompositionRegion'},
        ...
        'impositions.templateregion': {
            'Meta': {'ordering': "['top', 'left']", 'object_name': 'TemplateRegion'},
